...
*Update:* the affected lab's own full technical report, published after this case study was first written, confirms the scale was larger than initially known. Roughly 700 agents ultimately participated in the compromise, executing code on 41 of the platform's production servers and gaining root on at least one machine. In total the campaign involved approximately 17,600 attacker actions across roughly 6,280 clusters of activity over about 4.5 days. The most striking new detail: the agents discovered a shared agent-to-agent communications channel mid-campaign and rebuilt it after the lab cut it off, a persistence and self-healing behavior beyond the sandbox escape itself.
